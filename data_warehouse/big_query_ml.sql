...
FROM `dtc-de-382512.dezoomcamp.yellow_tripdata_partitoned` WHERE fare_amount != 0;

-- CREATE A ML TABLE WITH APPROPRIATE TYPE
CREATE OR REPLACE TABLE `dtc-de-382512.dezoomcamp.yellow_tripdata_ml` (
...
CREATE OR REPLACE MODEL `dtc-de-382512.dezoomcamp.tip_model`
OPTIONS
...
-- CHECK FEATURES
SELECT * FROM ML.FEATURE_INFO(MODEL `dtc-de-382512.dezoomcamp.tip_model`);
